...
<body>
	...
	<div class="container mt-1">
	   ...
	   <button type="button" class="btn btn-secondary" data-bs-toggle="collapse" data-bs-target="#ListTaskGeral">Tarefas</button>
	   ...
	   <div id="ListTaskGeral" class="collapse">
	   <?php 
			$mysqlix = new mysqli($host, $user, $pass, $db);
			$resultX = $mysqlix->query($query);
			// Monta a tabela HTML para exibir os resultados
			if ($resultX->num_rows > 0) {
			echo "<table  class='table table-striped'>
					<thead class='table-dark'>
